...
- (void)createButtonViewWithFrame:(CGRect)frame{
    ...
    [reStarBtn setTitleColor:FontColor forState:UIControlStateNormal];
    ...
    reStarBtn.layer.borderColor = MyColor.CGColor;
    ...
    [reBackBtn setTitleColor:FontColor forState:UIControlStateNormal];
    ...
    reBackBtn.layer.borderColor = MyColor.CGColor;
